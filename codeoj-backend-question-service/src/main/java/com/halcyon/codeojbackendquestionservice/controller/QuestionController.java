package com.halcyon.codeojbackendquestionservice.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;
import com.halcyon.codeojbackendcommon.annotation.AuthCheck;
import com.halcyon.codeojbackendcommon.common.BaseResponse;
import com.halcyon.codeojbackendcommon.common.DeleteRequest;
import com.halcyon.codeojbackendcommon.common.ResultUtils;
import com.halcyon.codeojbackendcommon.constant.UserConstant;
...
import com.halcyon.codeojbackendmodel.dto.question.*;
...
import com.halcyon.codeojbackendquestionservice.service.QuestionSubmitService;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request){
        ...
        ThrowUtils.throwIf(oldQuestion == null, ErrorCode.NOT_FOUND_ERROR);
        //仅本人或者管理员可编辑
        if (!oldQuestion.getUserId().equals(id) && !userFeignClient.isAdmin(loginUser)){
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
